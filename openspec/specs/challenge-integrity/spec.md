...
## Purpose
Preserve the integrity of the CTF-4 nested-Docker breakout challenge: the intended solve path stays reachable and offline-reproducible, staged secrets stay inaccessible to unintended readers, build inputs are pinned, and the walkthrough honestly documents the real gates versus realism flourishes.
